...
<form action="writeaboutmeRes.do" name="writeaboutmeRes" method="post" style="margin-top:5%; margin-left:5%;">
<h2 class="applytitle">Write Aboutme</h2><br/>
<input type="text" name="id" value="${id }" readonly style="width:30%; height:35px; font-size:15px; border:1px solid pink; border-radius:1%;"/><br/>
<input type="text" name="site" placeholder="https://www.nosion.so..." style="width:30%; height:35px; font-size:15px; border:1px solid pink; border-radius:1%;"/><br/>
<input type="text" name="certification" placeholder="Toeic,ToeicSpeaking..." style="width:30%; height:35px; font-size:15px; border:1px solid pink; border-radius:1%;"/><br/><br/>
...
<script type="text/javascript">
	function writeRes(){
		if($("input[name=site]").val() == ""){
			...
			writeaboutmeRes.target="parentForm";    //메인창의 이름값으로 타겟!
			writeaboutmeRes.submit();
		     self.close();
		}
	}
</script>
