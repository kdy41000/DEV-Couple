...
<textarea id="messageTextArea" rows="10" cols="50"></textarea>
    ...
    <script type="text/javascript">
		 ...
		 /* var webSocket = new WebSocket("ws://172.30.1.51:8787/prectice/broadsocket"); 로컬 ip*/
		 
		 var webSocket = new WebSocket("ws://34.64.150.252:8787/prectice/broadsocket"); // 배포서버 ip
		 // 콘솔 텍스트 에리어 오브젝트
