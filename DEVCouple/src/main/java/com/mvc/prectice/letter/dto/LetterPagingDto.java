...
public class LetterPagingDto {
	...
	public LetterPagingDto() {
		super();
		// TODO Auto-generated constructor stub
	}

	public LetterPagingDto(int startseq, int endseq, int underpagescale, int pagegroup, int totalpage, int currentpage,
